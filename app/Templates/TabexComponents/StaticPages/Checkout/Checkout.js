                    ...
                    {tabindex === 0 && (
                        <View style={{ marginTop: 0 }}>
                            ...
                            >
                                ...
                                />
                                {fetchcustomercartQueryContext?.data?.data?.customercart?.zonenotes != null && (
                                    <View
                                        style={{
                                            width: '100%',
                                            flexDirection: 'row',
                                    ...
                                    >
                                        <Text style={[generalstyles.poppinsMedium, { fontSize: 16 }]}>{langdetect == 'en' ? 'Notes:' : 'ملاحظات:'} </Text>
                                        <Text style={[generalstyles.poppinsMedium, { fontSize: 17, flex: 1, flexWrap: 'wrap' }]}>
                                            {fetchcustomercartQueryContext?.data?.data?.customercart?.zonenotes}
                                        </Text>
                                    </View>
                                )}
                            </View>
